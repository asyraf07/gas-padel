...
- **Quick score entry**: tap either team's score to open a score-picker modal with every option from 0 to the target (0–21) — picking one auto-derives the opponent score, so ties/over-totals are impossible.
